  ...
  return (
    <View style={styles.container}>
      <View style={styles.left}>
        <Text style={styles.title}>EFEK VAKSINASI</Text>
        <Text style={styles.num}>15,330,306</Text>
      </View>
      <View style={styles.right}>
        <View style={styles.itemRight}>
          ...
          <View style={styles.itemRightFill}>
            ...
            <Text style={styles.itemRightFillDesc}>Simtomatik</Text>
          </View>
        </View>
        <View style={styles.itemRight}>
          ...
          <View style={styles.itemRightFill}>
            ...
            <Text style={styles.itemRightFillDesc}>Asimtomatik</Text>
          </View>
        </View>
      </View>
    </View>
